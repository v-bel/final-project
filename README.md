...
Это последнее задание в курсе. Дедлайн - **пока не определен**!
...
Картинки покемонов и `db.json` для `json-server` можно найти в этом репозитории. (скоро будут добавлены)
